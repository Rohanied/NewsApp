 ...
 */
public class Technology extends Fragment implements OnRecyclerViewItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerView recyclerView = getActivity().findViewById(R.id.rv_tech);
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);

        final APIInterface apiservice = APIClient.getClient().create(APIInterface.class);
        Call<ResponseModel> call = apiservice.getLatestNews("in","technology",API_KEY);
